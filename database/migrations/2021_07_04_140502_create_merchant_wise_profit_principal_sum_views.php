...
class CreateMerchantWiseProfitPrincipalSumViews extends Migration
{
    private function createView(): string
    {
        return <<<'SQL'
        CREATE VIEW merchant_wise_profit_principal_sum_views AS
        SELECT 
        merchant_id,
        ...
        GROUP BY payment_investors.merchant_id
        SQL;
    }
    ...
    {
        return <<<'SQL'
        DROP VIEW IF EXISTS `merchant_wise_profit_principal_sum_views`;
        SQL;
    }
