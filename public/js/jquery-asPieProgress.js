...
(function(global, factory) {
    ...
    var DEFAULTS = {
        ...
        numberCallback: function numberCallback(n) {
            ...
            var percentage = Math.round(this.getPercentage(n)*100)/100;
            return percentage + '%';
        },
    ...
    var asPieProgress = (function() {
        function asPieProgress(element, options) {
            ...
            this.min = this.min ? parseFloat(this.min, 10) : this.options.min;
            this.max = this.max ? parseFloat(this.max, 10) : this.options.max;
