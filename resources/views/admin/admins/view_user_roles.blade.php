...
@section('content')
    ...
    {{ Breadcrumbs::render('admin::roles::show-user-role') }}
    <div class="col-md-12">
        <div class="box">
            <div class="box-head ">
                    ...
                    @if ($status == 0)
                        ...
                        <div class="form-filter">
                            <div class="form-filter-wrap">
                                <div class="row">
                                    <div class="col-sm-6">
                                        {{ Form::select('roles', $roles, '', ['class' => 'form-control js-roles-placeholder', 'id' => 'roles', 'placeholder' => 'Select Roles']) }}
                            ...
                            @if ($page_title == 'All Modules')
                                <div class="col-sm-2" style="padding-bottom:15px">
                                    @if (@Permissions::isAllow('Modules', 'Create'))
                                        <a href="{{ route('admin::roles::create-module') }}"
                                            class="btn btn-primary admin-btn">Create Module </a>
                                    @endif
                                </div>
                            @else
                                <div class="col-sm-2" style="padding-bottom:15px">
                                    @if (@Permissions::isAllow('Users', 'Create'))
                                        <a href="{{ route('admin::roles::create-user') }}"
                                            class="btn btn-primary admin-btn">Create User </a>
                                    @endif
                                </div>
                            @endif
                        @endif
