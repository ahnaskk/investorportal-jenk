...
@section('content')
    <div class="inner admin-dsh header-tp">
        <h3><i class="fa fa-angle-right" aria-hidden="true"></i>{{ isset($page_title) ? $page_title : '' }} for <span
                style="text-transform: capitalize; font-weight: 900; margin: 0; letter-spacing: 0.025em; color: #3a4c56; font-size: 18px;">{{ $user->name }}</span>
        </h3>
        <a href="#" class="help-link">
            <i class="fa fa-question-circle" aria-hidden="true"></i>
            <div class="tool-tip">Permissions for <span
                    style="text-transform: capitalize; color: #3a4c56; font-size: 13px; font-weight: 900; line-height: 15px;">{{ $user->name }}</span>
            </div>
        </a>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="box-lg-wrap">
            ...
            {!! Form::open(['route' => ['admin::admins::update_role_user', 'id' => $user->id], 'method' => 'POST']) !!}
    ...
    <div class="modal fade" id="confirmCopyPermission" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['method' => 'POST', 'id' => 'copy_permission_to_user']) !!}
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            var URL_confirmCopy = "{{ URL::to('admin/admin/copy_permission_to_user') }}";
