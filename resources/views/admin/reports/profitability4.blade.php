...
<div class="inner admin-dsh header-tp">
    ...
    <a href="#" class="help-link">
        ...
        <div class="tool-tip">Profitability Report (Equity)</div>     
    </a>
</div>
{{ Breadcrumbs::render('admin::reports::profitability4') }}
<div class="col-md-12">
    <div class="box">
        <div class="box-body">
            <div class="form-box-styled">
                {{Form::open(['route'=>'admin::reports::profitability4-export','id'=>'investor-form'])}}
                <div class="row" >
