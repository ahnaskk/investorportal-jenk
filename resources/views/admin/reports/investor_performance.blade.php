...
<div class="inner admin-dsh header-tp">
    ...
    <h3><i class="fa fa-angle-right" aria-hidden="true"></i>{{isset($title)?$title:''}} </h3>
      <a href="#" class="help-link">
        ...
        <div class="tool-tip">Investor Performance</div>     
      </a>
        ...
        <div class="form-group">
            <div class="filter-group-wrap" >
                <div class="filter-group" >
                    {{ Form::open(['route'=>'admin::reports::investor-performance-export']) }}
                    <?php
                    $dates = [];
                    if(isset($_GET['month']))
                    {
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input class="form-control valid_dates" id="valid_dates" autocomplete="off" name="valid_dates" type="text" value="{{ $monthYear }}"/>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input class="form-control" id="dates1" name="dates1" type="text" autocomplete="off"/>
...
@section('styles')
<link href="{{ asset('/css/optimized/Investor_Performance_Report.css?ver=5') }}" rel="stylesheet" type="text/css" />
@stop
