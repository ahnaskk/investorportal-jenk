        ...
        <div class="box-body no-padding">
            <div class="row">
                <div class="date-star" id="test" style="display:block">
                    {{Form::open(['route'=>'admin::reports::investor-rtr-balance-log-download','autocomplete'=>'on'])}}
                    ...
                    <div class="form-group col-md-1">
                        <div class="btn-box inhelpBlock">
                            <a href="{{url(route('admin::reports::investor-rtr-balance-log-create'))}}" class="btn btn-info">Create</a>
                        </div>
                    </div>
                    <div class="form-group col-md-1">
                        <div class="btn-box inhelpBlock">
                            <a href="{{url(route('admin::reports::investor-rtr-balance-log-truncate'))}}" class="btn btn-info">Remove All</a>
                        </div>
                    </div>
                    {{Form::close()}}
                </div>
