...
{{ Breadcrumbs::render('admin::sub_status::index') }}
<div class="col-md-12">
    <div class="box">
        <div class="box-head ">
                ...
                <div class="row">
                    <div class="col-sm-10"></div>
                     @if (!Auth::user()->hasRole('viewer')) 
                      @if(@Permissions::isAllow('Settings Sub Status','Create'))
                    <div class="col-sm-2" style="padding-bottom:15px">

                        <a href="{{route('admin::sub_status::create')}}" class="btn btn-primary" style="float: right;">Add Status</a>
