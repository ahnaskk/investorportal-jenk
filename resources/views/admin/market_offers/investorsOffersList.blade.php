 ...
 <div class="inner admin-dsh header-tp">
    ...
    <h3><i class="fa fa-angle-right" aria-hidden="true"></i>{{$page_title}} </h3>
      <a href="#" class="help-link">
        ...
        <div class="tool-tip">Investor Marketing Offers</div>     
      </a>
      
  </div>
{{ Breadcrumbs::render('admin::investorMarketOfferList') }}
    <div class="col-md-12">
            ...
            @include('layouts.admin.partials.lte_alerts')
             ...
             <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                 <div class="row">
                    ...
                    <a href="{{route('admin::addEditInvestorsOffers')}}" class="btn btn-primary admin-btn" style="float:right; margin-bottom:8px">Create Offers</a>
                   @endif
                    </div>
                  </div>
                <div class="row">
