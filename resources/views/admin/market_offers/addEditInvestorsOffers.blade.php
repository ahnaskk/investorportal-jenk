...
<div class="inner admin-dsh header-tp">
  ...
  <?php $offer_id=isset($_GET['id'])?$_GET['id']:''; ?>
      @if($offer_id)
         {{ Breadcrumbs::render('investor_marketing_offers_edit') }}
       @else
         {{ Breadcrumbs::render('investor_marketing_offers_create') }}
       @endif
    <div class="col-md-12">
        <!-- general form elements -->
        <div class="box box-primary box-sm-wrap">

               {!! Form::open(['route'=>'admin::addUpdateInvestorMarketOffer', 'method'=>'POST','id'=>'crete_offer_form']) !!}
               ...
               {!! Form::hidden('offer_id',$offer_id,['class'=>'form-control','id'=> 'offer_id']) !!}
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="exampleInputEmail1">Investor Type</label>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Investors <span class="validate_star">*</span></label>
                    {!! Form::select('investors[]',$investors,isset($selected_investor) ? $selected_investor:old('investors'),['class'=>'form-control js-investor-placeholder-multiple','multiple','id'=>'investors']) !!}
                     <span id="invalid-inputMerchant" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="btn-box">
                    ...
                    <a href="{{URL::to('admin/investorMarketOfferList')}}"  class="btn btn-success">View Offers</a>
        ...
        rules: {
            ...
            'investors[]':{
              required: function(element) {
                if($('#inputInvestorType').val()!= void null) return true;
                else return false;
              },
            },
        },
                ...
                if(data.status==1)
                {
                     ...
                     if(type==0){
                        $.each(data.investors, function(i, d) {
                          $('#investors').append('<option value="' + i + '">'+ d + '</option>');                        
                      });
