            ...
            <div class="row">
                <div class="col-md-4" style="margin-bottom: -2px;">
                    <div class="input-group">
                        ...
                        {{Form::select('user_id',[''=>'All']+$users,'',['class'=>'form-control table_change select2_class','id'=>'user_id'])}}
                    </div>
                    <span class="help-block">{{Form::label('user_id','Users')}}</span>
                </div>
                <div class="col-md-4" style="margin-bottom: -2px;">
                    <div class="input-group">
                        {{ Form::checkbox('diff',1,true,['id'=>'diff','class'=>'table_change']) }}&emsp;
                    </div>
                    <span class="help-block">{{Form::label('diff','Exclude Rows without Difference')}}</span>
                </div>
                <div class="col-md-2" style="margin-bottom: -2px;">
                    <div class="input-group">
                        <a href="{{route('PennyAdjustment::UpdateLiquidityDifference')}}" class="btn btn-info">Update</a>
                    </div>
                    <span class="help-block">Update the Liquidity</span>
                </div>
            </div>
        </div>
        <div class="box-body no-padding">
