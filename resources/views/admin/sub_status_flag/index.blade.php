...
{{ Breadcrumbs::render('admin::sub_status_flag::index') }}
<div class="col-md-12">
    <div class="box">
        <div class="box-head ">
            ...
            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <div class="row">
                    <div class="col-sm-10"></div>
                     ...
                     @if(@Permissions::isAllow('Settings Sub Status Flag','Create'))
                    <div class="col-sm-2" style="padding-bottom:15px">

                        <a href="{{route('admin::sub_status_flag::create')}}" class="btn btn-primary" style="float: right;">Add Sub Status Flag</a>
