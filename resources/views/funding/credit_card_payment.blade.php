    ...
    <div class="container">
        <div class="row">
            ...
            <div class="payment-form-right col-md-6">
                <form action="{{ url('fundings/process_stripe_payment') }}" novalidate data-parsley-validate role="form" action="" method="post" class="payment-form require-validation" data-cc-on-file="false"  data-stripe-publishable-key="{{ $stripe_key }}"  id="payment-form">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="field-group">
                                ...
                                <input data-parsley-error-message="Enter Amount" data-parsley-minlength="1"   required name="amount"  id="amount" autocomplete='off'  class="field"  size='20' type="text" placeholder="00.00"  >
