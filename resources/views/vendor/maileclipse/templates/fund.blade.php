...
<tbody>
<tr>
<td style="padding: 20px 0; text-align: center;"><img src="http://placehold.it/200x50" alt="alt_text" width="200" height="50" border="0" /></td>
</tr>
</tbody>
</table>
<!-- Email Header : END --> <!-- Email Body : BEGIN -->
<table class="email-container" style="margin: auto;" border="0" width="600" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff"><!-- Hero Image, Flush : BEGIN -->
<tbody>
<tr>
<td><img style="width: 100%; max-width: 600px;" src="http://placehold.it/300x300" alt="alt_text" width="600" height="" align="center" border="0" /></td>
</tr>
<!-- Hero Image, Flush : END --> <!-- 1 Column Text : BEGIN -->
<tr>
<td style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">Maecenas sed ante pellentesque, posuere leo id, eleifend dolor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Praesent laoreet malesuada cursus. Maecenas scelerisque congue eros eu posuere. Praesent in felis ut velit pretium lobortis rhoncus ut&nbsp;erat. <br /><br /><!-- Button : Begin -->
<table style="margin: auto;" border="0" cellspacing="0" cellpadding="0" align="center">
<tbody>
<tr>
<td class="button-td" style="border-radius: 3px; background: #222222; text-align: center;"><a class="button-a" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" href="http://www.google.com"> &nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #ffffff;">A Button</span>&nbsp;&nbsp;&nbsp;&nbsp; </a></td>
</tr>
</tbody>
</table>
<!-- Button : END --></td>
</tr>
<!-- 1 Column Text : BEGIN --> <!-- Background Image with Text : BEGIN -->
<tr><!-- Bulletproof Background Images c/o https://backgrounds.cm -->
<td style="text-align: center; background-position: center center !important; background-size: cover !important;" valign="middle" bgcolor="#222222"><!-- [if gte mso 9]>
...
<tbody>
<tr>
<td style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #ffffff;" valign="middle">Maecenas sed ante pellentesque, posuere leo id, eleifend dolor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Praesent laoreet malesuada cursus. Maecenas scelerisque congue eros eu posuere. Praesent in felis ut velit pretium lobortis rhoncus ut&nbsp;erat.</td>
</tr>
</tbody>
</table>
</div>
...
<tbody>
<tr>
<td style="padding: 10px; text-align: center;"><img class="fluid" src="http://placehold.it/270" alt="alt_text" width="270" height="270" border="0" /></td>
</tr>
<tr>
<td class="center-on-narrow" style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 0 10px 10px; text-align: left;">Maecenas sed ante pellentesque, posuere leo id, eleifend dolor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</td>
</tr>
</tbody>
</table>
</td>
...
<tbody>
<tr>
<td style="padding: 10px; text-align: center;"><img class="fluid" src="http://placehold.it/170" alt="alt_text" width="170" height="170" border="0" /></td>
</tr>
<tr>
<td class="center-on-narrow" style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 0 10px 10px; text-align: left;">Maecenas sed ante pellentesque, posuere leo id, eleifend dolor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</td>
</tr>
...
<tr>
<td dir="ltr" style="padding: 10px;" align="center" valign="top" width="100%">
<table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
<tbody>
<tr><!-- Column : BEGIN -->
<td class="stack-column-center" width="33.33%">
...
<tbody>
<tr>
<td dir="ltr" style="padding: 0 10px;" valign="top"><img class="center-on-narrow" src="http://placehold.it/170" alt="alt_text" width="170" border="0" /></td>
</tr>
</tbody>
</table>
</td>
...
<tbody>
<tr>
<td class="center-on-narrow" dir="ltr" style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 10px; text-align: left;" valign="top"><strong style="color: #111111;">Class aptent taciti sociosqu</strong> <br /><br />Maecenas sed ante pellentesque, posuere leo id, eleifend dolor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. <br /><br /><!-- Button : Begin -->
...
<tr>
<td dir="rtl" style="padding: 10px;" align="center" valign="top" width="100%">
<table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
<tbody>
<tr><!-- Column : BEGIN -->
<td class="stack-column-center" width="33.33%">
...
<!-- Thumbnail Right, Text Left : END --></tbody>
</table>
