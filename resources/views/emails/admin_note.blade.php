...
<tr>
		<td class="main-wrap-top" align="center" valign="top" style=" background: #181c3f; padding: 35px 0 0;"> 
			<table width="650" border="0" align="center" cellspacing="0" cellpadding="0" class="mobile-shell">
				...
				<tr>
					<td style="font-size:0pt; line-height:0pt; text-align:center; ">
						<img src="{{URL::to('velocity-mail-images/top-curve-adam.png')}}" width="650" height="9" border="0" alt="">
					</td>
				</tr>
				<td class="logo" style="padding: 30px 50px; font-size:0pt; line-height:0pt; text-align:left; background: #fff;">
					<img src="{{URL::to('velocity-mail-images/logo.png')}}" width="261" height="55" border="0" alt="">
				</td>
			</table>
		</td>
</tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
                                           ...
                                           Hello Velocity,                                          
											...
											<tr>
												<td style="padding: 0;">
													<img src="{{URL::to('velocity-mail-images/curved-bottom.png')}}" width="650" height="16">
												</td>
											</tr>
