								...
								<tr>
									<td >
										<div class="wrapper-inner">
											<table width="100%" cellpadding="0" cellspacing="0" style="">
												<tr>
													<td class="logo" style="font-size:22px; color: #70748e; line-height:36px; padding: 0; background: #fff;  font-family: Arial, sans-serif, Helvetica, Verdana; font-weight: 700; ">
														Hello {{$investor_name}},
													</td>													
												</tr>
