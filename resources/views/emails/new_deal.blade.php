									...
									<td >
										<div class="wrapper-inner">
											<table width="100%" cellpadding="0" cellspacing="0" style="">
												...
												<tr>
													<td class="content" style="font-size:22px; line-height: 44px; color: #1f244c; letter-spacing: -0.04em; padding: 45px 30px 10px 30px; background: #fff;  font-family: Arial, sans-serif, Helvetica, Verdana; font-weight: 400;">
												           {!! $content !!}

												          <br>

								 <a href="{{URL::to('investors/marketplace')}}" style="padding: 2px 45px; margin:15px 0 0; display: inline-block; width: auto; text-decoration: none; border-radius: 35px; color: #fff; background: #2db77e; font-size: 16px; font-weight: bold; ">View Merchant
												        </a>
