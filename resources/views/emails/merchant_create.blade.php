									...
									<td >
										<div class="wrapper-inner">
											<table width="100%" cellpadding="0" cellspacing="0" style="">
												...
												<tr>
													<td class="content" style="font-size:22px; line-height: 44px; color: #1f244c; letter-spacing: -0.04em; padding: 45px 30px 10px 30px; background: #fff;  font-family: Arial, sans-serif, Helvetica, Verdana; font-weight: 700;">
														A new merchant called <a href="{{ url('admin/merchants/view/'.$merchant_id) }}">{{ $merchant_name }} </a> created by {{ $creator }} .
														
													</td>													
												</tr>
                                          @foreach($company_amounts as $company_dt)

                                              <tr>
													<td class="content" style="padding: 0 30px 15px 30px; background: #fff;  font-family: Arial, sans-serif, Helvetica, Verdana;">
														<div style="background: #fdfdff; border-radius: 8px; border: 1px solid #eeedf5; color: #535777; font-weight: bold; line-height: 26px; padding: 15px 25px;">
															{{ $company_dt['name'] }} Participated<span style="font-weight: bold; display: block; font-size: 20px;     color: #28b76e;  margin: 7px 0 0;">
															{{ FFM::dollar($company_dt['max_participant']) }} ({{ round($company_dt['per'],2)}}%).</span>
														</div>
													</td>
												</tr>
