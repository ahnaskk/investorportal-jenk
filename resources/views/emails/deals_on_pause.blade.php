									...
									<td>
										<div class="wrapper-inner">
											<table width="100%" cellpadding="0" cellspacing="0" style="">
												...
												<tr>
											<td class="content" style="font-size:10px; line-height: 44px; color: #1f244c; letter-spacing: -0.04em; padding: 45px 30px 15px 30px; background: #fff;  font-family: Arial, sans-serif, Helvetica, Verdana; font-weight: 700;">
