		...
		<table width="100%" border="1" cellspacing="0" cellpadding="0">
			<thead>
				...
				<tr>
					...
					<td style="padding: 10px 50px 10px;font-weight: bold; color: #3d3d3d;">{{$company}}</td>
				</tr>
                	<tr>
...
@endif
											...
											<tr>
												<td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:center; background: #fff; padding: 15px 0 20px 0;"><img src="http://qc.investorportal.vgusa.com/velocity-mail-images/logo-gray.png" width="176" height="36" border="0" alt=""></td>
											</tr>
