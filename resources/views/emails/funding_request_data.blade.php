											...
											<table width="100%" cellpadding="0" cellspacing="0" style="">
												...
												<tr>
													<td class="content" style="padding: 25px 30px 15px 30px; background: #fff;  font-family: Arial, sans-serif, Helvetica, Verdana;">
														<a href="{{$doc_url}}" style="padding: 12px 45px; text-decoration: none; border-radius: 35px; color: #fff; background: #d33724; font-size: 16px; font-weight: bold; ">View document</a>
													</td>
												</tr>
