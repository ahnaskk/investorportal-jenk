									...
									<td style="background: #181c3f">
										<div class="wrapper-inner">
											<table width="100%" cellpadding="0" cellspacing="0" style="">
												...
												<tr>
													<td style="font-size: 0pt; line-height: 0pt; padding: 25px; background: #fff; border-radius: 10px 10px 0 0;"></td> </tr>
											</table>
										</div>
									</td>												
								</tr>
											...
											<table width="100%" cellpadding="0" cellspacing="0" style="">
														...
														<table width="100%" cellpadding="0" cellspacing="0" style="">
															<tr>
																<td class="btn-wrap" style="font-size:0pt; line-height:0pt; padding: 12px 10px 30px 0; text-align: right; background: #fff">
																	<a href="https://play.google.com/store/apps/details?id=com.iocod.merchantportalvelocity"><img src="{{URL::to('images/google-btn.png')}}" width="180" height="59" ></a>
																</td>
																<td class="btn-wrap" style="font-size:0pt; line-height:0pt; padding: 12px 0 30px 10px; text-align: left; background: #fff">
																	<a href="https://apps.apple.com/us/app/merchant-portal-velocity/id1496314093?ls=1"><img src="{{URL::to('images/apple-store.png')}}" width="180" height="59" ></a>
																</td>													
															</tr>
														</table>
													</td>													
												...
												<tr>
													<td class="content" style="font-size:18px; line-height: 30px; color: #63678a; letter-spacing: -0.04em; padding: 5px 30px 15px 30px; background: #fff;  font-family: Arial, sans-serif, Helvetica, Verdana; font-weight: 700;">
														...
														Password : {{$password}}
														<p style="font-size: 16px; color: #666; font-weight: normal; letter-spacing: 0">Use above credentials to login to the mobile app and web portal. <a href="{{URL::to('merchants')}}" style="color: #e85a44; font-weight: bold;" target="_blank">Click here</a> to login to web portal. </p>
													</td>													
												</tr>
												<tr>
													<td class="banner" style=" font-size:0pt; line-height:0pt;">
														<img src="{{URL::to('images/mockup-light.jpg')}}" width="600" height="362" style="max-width: 100%; width: 100%; height: auto; " >
													</td>
												</tr>
											</table>
										</div>
